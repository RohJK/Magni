...
public class CaptureCheckActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout = (RelativeLayout)findViewById(R.id.captureLayout);
/*
...
*/
        ...
        zoomValue = intent.getIntExtra("ZOOMSTATE",0);
        ...
        lengthButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(nanoPerPx!=0 && zoomValue == 0) {
                    ...
                    if(zoomValue == 1)
                    {
                        Toast.makeText(getApplicationContext(), "확대촬영 한 사진은 길이측정을 할 수 없습니다", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
...
*/               pointView.dspHeight =  pointView.getMeasuredHeight();
               ...
               // File file = new File(filePath);
                ...
                try {
                    ...
                    CaptureCheckActivity.this.sendBroadcast(new Intent( Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(file)) );
